...
class Ad(models.Model):
    ...
    photo = models.ImageField(verbose_name='Фотография', upload_to='photos/', blank=True, null=True)
    price = models.IntegerField(verbose_name='Цена')
    view_count = models.IntegerField(verbose_name='Кол-во просмотров', default=0, editable=False)
    tags = models.ForeignKey(Tag, related_name='tags', on_delete=models.CASCADE, default=0)
